...
# axes[0].spines['right'].set_linewidth(0.5)  # Lighter right axis
# axes[0].spines['top'].set_linewidth(0.5)  # Lighter top axis

# # Ensure the axes form a complete frame, making sure the top and right sides are visible.
# axes[0].spines['top'].set_color('gray')  # Lighter color for the top
# axes[0].spines['right'].set_color('gray')  # Lighter color for the right

# Add the additional bottom line at y = -0.1
# axes[0].axhline(y=-0.1, color='gray', linewidth=1.5, linestyle='-', zorder=5)
...
# axes[1].spines['right'].set_linewidth(0.5)  # Lighter right axis
# axes[1].spines['top'].set_linewidth(0.5)  # Lighter top axis

# # Ensure the axes form a complete frame, making sure the top and right sides are visible.
# axes[1].spines['top'].set_color('gray')  # Lighter color for the top
# axes[1].spines['right'].set_color('gray')  # Lighter color for the right

# axes[1].legend(fontsize=10)
# axes[1].set_xlim(left=0)

# ymin, ymax = axes[1].get_ylim()
# axes[1].hlines(y=ymin, xmin=axes[1].get_xlim()[0], xmax=axes[1].get_xlim()[1],
#                color='gray', linewidth=1.5, zorder=6)
plt.tight_layout()
