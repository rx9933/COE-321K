...
dataname = "../testingtruss/224_TA/input.txt" #  "nonLinear3DTetrahedron.txt"
# dataname = "../hw2p1.txt"
iterations = 1
...
def calculate(node, strain_constant):
    ...
    # print(force_index_bc[0]*ndim )
    inds = force_index_bc[0]*ndim + force_index_bc[1]
    for i,v in enumerate(force_values):
        Fk[np.argwhere(kfi==inds[i])] = v
